...
const PackageDetails = ({ params }) => {
  ...
  return (
    <div>
      ...
      {/* route section  */}
      <div className="py-3 md:py-4 lg:py-6 flex items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h5 className="flex items-center flex-wrap gap-2 md:gap-3 text-sm md:text-base">
          <Link href="/" className="hover:text-[#00BB98] transition-colors">
            Home
          </Link>
          <LiaAngleRightSolid />
          <Link
            href="/tour-lists"
            className="hover:text-[#00BB98] transition-colors"
          >
            Tour
          </Link>
          <LiaAngleRightSolid />
          <span className="text-[#00BB98]">{tour.title}</span>
        </h5>
      </div>
