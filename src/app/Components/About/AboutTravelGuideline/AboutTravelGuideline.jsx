...
const AboutTravelGuideline = () => {
    return (
        ...
        >
            <div className="space-y-4 text-start max-w-5xl mx-auto pt-20">
            ...
            {/* absolute  */}
            <div className='absolute p-4 rounded-lg bg-[#D0A148] right-3/12 top-20 flex flex-col items-center justify-center text-[#FFF]'>
